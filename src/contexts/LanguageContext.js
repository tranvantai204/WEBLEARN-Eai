...
export const LanguageProvider = ({ children }) => {
    ...
    const staticTranslations = useMemo(() => ({
        ...
        vi: {
            ...
            'Waiting for game to end...': 'Đang chờ trò chơi kết thúc...',
            'Continue Watching': 'Tiếp Tục Xem',
            'You Completed!': 'Bạn đã hoàn thành',
            'You finished all questions! Waiting for others...': 'Bạn đã làm xong hết rồi! Đang chờ các bạn khác nha...',
            'Well Done!': 'Làm tốt lắm!',
            'You have completed all questions': 'Bạn đã hoàn thành tất cả câu hỏi!',
            'You have successfully answered all questions. Now you can wait for other players to finish or start a new game.': 'Bạn thật giỏi! Giờ thì cùng đợi các bạn khác trả lời xong hoặc chơi lại nha!',
            'Wait for other players to finish': 'Chờ các bạn khác làm xong',
            'Keep Waiting': 'Tiếp tục chờ',
            'Stay to see final results': 'Ở lại xem kết quả cuối cùng',
            'New Game': 'Chơi lại',
            'Start fresh in lobby': 'Vào lại sảnh để chơi tiếp',
            'Master new languages the smart way powered by': 'Chinh phục ngôn ngữ theo cách thông minh với',
            ' cutting-edge AI': ' Công nghệ AI tiên tiến',
